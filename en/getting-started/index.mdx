...
- ✅ Your valid CUIT number with fiscal key level 3
...
<CardGroup cols={2}>
  <Card title="🔐 Digital Certificate Guide" icon="document-text" href="https://facture.ar/58874f1a-1abf-400c-b444-4a20c020e3e0_Gua_para_configurar_tu_CUIT.pdf">
    Download the complete guide to configure your CUIT with digital certificate
  </Card>
  <Card title="🤝 Delegation Guide" icon="document-text" href="https://facture.ar/e072df0a-99bb-4dc7-85c4-cfea91bdb64a_Gua_para_la_delegacin_del_CUIT.pdf">
    Download the complete guide for CUIT delegation
  </Card>
</CardGroup>
...
Follow the guide steps (delegate in AFIP, create point of sale, wait for our acceptance):
...
2. **Validate configuration**: Verify everything is correct
...
2. Navigate to **Taxes**
3. Add the taxes you need (national or provincial taxes)
...
3. **[Customize your setup](/en/guides/customization)** - Adjust the platform to your needs
