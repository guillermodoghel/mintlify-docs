...
- ✅ [Cuenta activa en Facturear](https://facturear.com)
...
1. Iniciá sesión en [facturear.com](https://facturear.com)
...
```bash
curl -X POST https://api.facturear.com/invoices \
...
```json
{
  ...
  "total": 847000,
  "pdfUrl": "https://api.facturear.com/pdf/inv_abc123",
  "estado": "aprobada"
}
```
...
```bash
GET https://api.facturear.com/pdf/{invoiceId}
```
